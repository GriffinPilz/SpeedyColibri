//! Unicode property range tables for the tokenizer's pre-tokenizer.
//!
//! GENERATED from c/tok_unicode.h by scripts/gen_unicode.py — do not edit by hand.
//! `is_l`/`is_n`/`is_s` mirror the C `is_L`/`is_N`/`is_S` (\p{L}, \p{N}, \s).

#[rustfmt::skip]
pub static UNI_L: &[(u32, u32)] = &[
...
pub static UNI_N: &[(u32, u32)] = &[
    ...
    (0x3251, 0x325F), (0x3280, 0x3289), (0x32B1, 0x32BF), (0xA620, 0xA629), (0xA6E6, 0xA6EF),
    (0xA830, 0xA835), (0xA8D0, 0xA8D9), (0xA900, 0xA909), (0xA9D0, 0xA9D9), (0xA9F0, 0xA9F9),
    (0xAA50, 0xAA59), (0xABF0, 0xABF9), (0xFF10, 0xFF19), (0x10107, 0x10133), (0x10140, 0x10178),
...
/// `\p{L}` — Unicode letter.
#[inline] pub fn is_l(c: u32) -> bool { uni_in(UNI_L, c) }
/// `\p{N}` — Unicode number.
#[inline] pub fn is_n(c: u32) -> bool { uni_in(UNI_N, c) }
/// `\s` — whitespace (the cl100k set).
#[inline] pub fn is_s(c: u32) -> bool { uni_in(UNI_S, c) }
